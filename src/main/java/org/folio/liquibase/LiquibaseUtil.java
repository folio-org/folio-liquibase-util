...
public final class LiquibaseUtil {
  ...
  public static void initializeSchemaForModule(Vertx vertx, String moduleConfigSchema) {
    LOGGER.info("Initializing schema {} for the module", moduleConfigSchema);
  ...
  public static void initializeSchemaForTenant(Vertx vertx, String tenant) {
    ...
    try (Connection connection = getConnection(vertx, tenant)) {
      ...
      LOGGER.error("Error while initializing schema {} for tenant {}", schemaName, tenant, e);
      throw new RuntimeException(e);
    }
  }
   ...
   */
  @SuppressWarnings("java:S2077") // SQL injection is not possible here
  private static void createModuleConfigurationSchema(Connection connection, String moduleConfigSchema)
    throws SQLException {
